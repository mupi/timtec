...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in orm.TimtecUser.objects.all():
            if user.picture:
                a = orm['avatar.Avatar'].objects.create(user=user, avatar=user.picture, primary=True)
                a.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for avatar in orm['avatar.Avatar'].objects.filter(primary=True):
